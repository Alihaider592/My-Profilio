  ...
  useEffect(() => {
    const handleNavClick = (e: Event) => {
      ...
      if (target && target.getAttribute("href") === "#about") {
        setTimeout(() => {
          triggerAnimation()
        }, 100) // Small delay to allow smooth scroll
      }
    }
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-6 transition-all duration-1000 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-20 opacity-0"}`}>
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p className={`text-lg transition-all duration-1000 delay-500 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
              ...
              <p className={`transition-all duration-1000 delay-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
              ...
              <p className={`transition-all duration-1000 delay-900 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-300 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"}`}>
            ...
            <div className={`space-y-4 pt-6 border-t border-border transition-all duration-1000 delay-1000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                {[
                  ...
                  <div key={i} className={`flex items-center gap-3 transition-all duration-700 delay-[${1200 + i * 200}ms] ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}>
